 ...
 return array_merge_recursive( array (
  ...
  array (
	...
	<div class=\'ipsBox ipsBox--child ipsPadding\'>
		...
		<span class=\'cNexusPrice\' style=\'font-size: 1.4em;\'>{{if !empty( $pncSnapshot[ \'total_display\' ] )}}{$pncSnapshot[ \'total_display\' ]}{{else}}{$invoice->total}{{endif}}</span>
		<p class=\'ipsType_light ipsType_small ipsType_reset ipsSpacer_top ipsSpacer_half\'>{lang="xpaynowcheckout_provider_charged_label"}</p>
		{{if !empty( $pncSnapshot[ \'paynow_pretty_id\' ] )}}
			<p class=\'ipsType_light ipsType_small ipsType_reset\'>{lang="xpaynowcheckout_settle_pretty_id"}: {$pncSnapshot[ \'paynow_pretty_id\' ]}</p>
		{{endif}}
		<p class=\'ipsType_light ipsType_small ipsType_reset ipsSpacer_top ipsSpacer_half\'>{lang="xpaynowcheckout_ips_invoice_total_label"}: {$invoice->total}</p>
